...
public class GcmBroadcastReceiver extends BroadcastReceiver {
  ...
  // context.getContentResolver().insert(DataProvider.CONTENT_URI_MESSAGES,
  // values);
  //
  // if (Common.isNotify()) {
  ...
  private void sendNotification(String text, boolean launchApp) {
    ...
    if (!TextUtils.isEmpty(Util.getRingtone())) {
      notification.setSound(Uri.parse(Util.getRingtone()));
    }
